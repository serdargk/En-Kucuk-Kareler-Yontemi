clc; clear; close all;
% y=a*x^b þeklinde modellenen yaklaþýk üstel fonksiyonun belirlenmesi
%x=[2 3 4 6 7 9];
...
a=inv(A)*B  %Modelenen yaklaþýk ustel fonksiyonun katsayýlarýnýn hesaplanmasý
F=exp(a(1,1))*(x.^a(2,1))%Katsayýlarý hesaplanan ustel fonksiyonun deðeri
